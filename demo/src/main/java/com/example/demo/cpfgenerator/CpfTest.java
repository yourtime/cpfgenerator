...
public class CpfTest {
    ...
    private int randomCpf(int n) {
        int ranNum = (int) (Math.random() * n);
        return ranNum;
    }

    private int mod(int divide, int divisor) {
        return (int) Math.round(divide - (Math.floor(divide / divisor) * divisor));
    }
    ...
    public String cpf() {
        ...
        if (isValid)
            returnValue = "" + n1 + n2 + n3 + '.' + n4 + n5 + n6 + '.' + n7 + n8 + n9 + '-' + d1 + d2;
        else
            returnValue = "" + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + d1 + d2;
    ...
    public String cnpj() {
        ...
        int n7 = randomCpf(n);
        int n8 = randomCpf(n);
        int n9 = 0; //randomCpf(n);
        int n10 = 0; //randomCpf(n);
        int n11 = 0; //randomCpf(n);
        int n12 = 1; //randomCpf(n);
        ...
        if (isValid)
            returnValue = "" + n1 + n2 + "." + n3 + n4 + n5 + "." + n6 + n7 + n8 + "/" + n9 + n10 + n11 + n12 + "-" + d1 + d2;
        else
            returnValue = "" + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + d1 + d2;
	...
	if (d2>=10) d2 = 0;
	retorno = '';
	if (isValid) retorno = ''+n1+n2+n3+'.'+n4+n5+n6+'.'+n7+n8+n9+'-'+d1+d2;
	...
	var n7 = randomCpf(n);
	var n8 = randomCpf(n);
	var n9 = 0; //randomCpf(n);
	var n10 = 0; //randomCpf(n);
	var n11 = 0; //randomCpf(n);
	var n12 = 1; //randomCpf(n);
	...
	if (d2>=10) d2 = 0;
	retorno = '';
	if (isValid) retorno = ''+n1+n2+'.'+n3+n4+n5+'.'+n6+n7+n8+'/'+n9+n10+n11+n12+'-'+d1+d2;
